...
<div class="flex items-center justify-center min-h-[400px] sm:min-h-[500px] mt-4">
    <div class="relative w-full sm:w-4/5">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
            ...
            <p class="text-lg sm:text-xl text-black mt-2">Bharat Rathod</p>
        </div>
    </div>
</div>
...
<div class="mt-12 max-w-7xl mx-auto px-6">
    ...
    <div class="m-12 bg-gray-50 p-6 rounded-lg flex flex-col sm:flex-row items-center">
        ...
        <div class="w-full sm:w-2/3 sm:pl-6 mt-6 sm:mt-0">
            <h3 class="text-2xl font-semibold text-blue-500 mb-4">Chapter Lead: Bharat Rathod</h3>
            <p class="text-gray-600 text-lg leading-relaxed">Bharat Rathod is the founder of Bahujan Scholars. He works as the Assistant Director of Inclusion and Engagement at University of Massachusetts (UMass) Amherst. He has a doctorate degree in International Education from UMass Amherst and his research interests include caste, race, higher education in India, diversity, equity and inclusion framework, and qualitative research.</p>
        </div>
    </div>
